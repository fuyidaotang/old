...
function valiant_360($, THREE, Detector, window, document, undefined) {
    ...
    Plugin.prototype = {
        ...
        createControls: function() {
            ...
            $(this.element).append(controlsHTML, false);
            $(this.element).append('<div class="timeTooltip">00:00</div>', false);
