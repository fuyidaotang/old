...
var resolve = {
    ...
    alias: {
        ...
        swiper:path.join(PATHS.libsPath, "js/swiper/idangerous.swiper.js"),
        iscroll:path.join(PATHS.libsPath, "js/iscroll/iscroll.js"),
        THREE:path.join(PATHS.libsPath, "js/three.min.js"),
...
var entry = {
    ...
    common: [
        ...
        path.join(PATHS.libsPath, "js/swiper/idangerous.swiper.js"),
        path.join(PATHS.libsPath, "js/iscroll/iscroll.js"),
        path.join(PATHS.libsPath, "js/three.min.js")
    ],
};
...
var plugins = [
    ...
    new HtmlWebpackPlugin({
        filename: 'html/head/headerIndex.html',
        template: __dirname + '/src/html/head/headerIndex.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/foot/footerIndex.html',
        template: __dirname + '/src/html/foot/footerIndex.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/head/headerNavOne.html',
        template: __dirname + '/src/html/head/headerNavOne.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/head/headerNavTwo.html',
        template: __dirname + '/src/html/head/headerNavTwo.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/foot/footerOther.html',
        template: __dirname + '/src/html/foot/footerOther.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/index/index.html',
        template: __dirname + '/src/html/index/index.html',
        inject: false,
    })
];
