...
var resolve = {
    ...
    alias: {
        ...
        swiper:path.join(PATHS.libsPath, "js/swiper/swiper-3.4.0.min.js"),
        fastclick:path.join(PATHS.libsPath, "js/fastclick.js"),
...
var entry = {
    ...
    common: [
        ...
        path.join(PATHS.libsPath, "js/swiper/swiper-3.4.0.min.js"),
        path.join(PATHS.libsPath, "js/vue.2.0.8.js"),
        path.join(PATHS.libsPath, "js/fastclick.js")
    ],
};
...
var plugins = [
    ...
    new HtmlWebpackPlugin({
        ...
        template: __dirname + '/src/html/detail.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/confirmOrder.html',
        template: __dirname + '/src/html/confirmOrder.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/choosePayType.html',
        template: __dirname + '/src/html/choosePayType.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/my.html',
        template: __dirname + '/src/html/my.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/chooseAddress.html',
        template: __dirname + '/src/html/chooseAddress.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/shareCode.html',
        template: __dirname + '/src/html/shareCode.html',
        inject: false,
    }),
    new HtmlWebpackPlugin({
        filename: 'html/addAddress.html',
        template: __dirname + '/src/html/addAddress.html',
        inject: false,
    })
];
    ...
    config = Merge(
        config,
        {
            plugins: [
                ...
                new OpenBrowserPlugin({url: 'http://localhost:8089' + PATHS.publicPath + 'index.html'})
            ],
            devServer: {
                ...
                port: "8089",  // Defaults to 8080   process.env.PORT
                /*
                 *  代理访问
